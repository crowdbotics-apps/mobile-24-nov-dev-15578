...
const styles = StyleSheet.create({
  ...
  View_1: {},
  CheckBox_2: { textTransform: "uppercase" },
  CheckBox_3: { textTransform: "uppercase" },
  TextInput_4: { textTransform: "uppercase" },
  TextInput_5: { textTransform: "uppercase" },
  Text_6: { textTransform: "uppercase" },
  Button_7: { textTransform: "capitalize" },
  TextInput_8: { textTransform: "uppercase" }
})
